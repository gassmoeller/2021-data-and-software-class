...
def test_process_data():
    """A test for the process_data() function."""
...
def test_plot_data():
    """A test for the plot_data() function."""
...
# Copied content from https://raw.githubusercontent.com/gassmoeller/
# 2021-data-and-software-class/test_pytest_ci/tests/test_plotting.py
