...
def process_data(temperature_data):
    """Given some input temeprature data this function converts the second column from
    degrees Fahrenheit to Kelvin and appends a new column with what data."""
...
def plot_data(processed_temperature_data, plot_filename):
    """Given some input temeprature data this function plots the third column of the input
    data into a file with the name plot_filename."""
...
def convert_data(filename, output_filename):
    """Read data from a csv file called filename into a Pandas Dataframe, and write this
...
def plot():
    """Main program that reads a dataset, process it, plots it, and write the converted
