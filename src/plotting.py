...
def process_data(temperature_data):
    ...
    degrees Fahrenheit to Kelvin and appends
    a new column with what data."""
...
def plot_data(processed_temperature_data, plot_filename):
    """Given some input temperature data and a file name function
     plots the third column of the input data into a file with the name plotfilename."""
...
def plot():
    ...
    plots it, and writes the converted data into json file."""
